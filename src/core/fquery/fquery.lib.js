...
class FQuery {
	 ...
	 * @returns {FQuery/string} The current FQuery instance for
	 ...
	 * @returns {FQuery} The current FQuery instance for chaining.
	 */
	click(callback) {
	 ...
	 * @returns {ROuery/string} The current RQuery instance for
